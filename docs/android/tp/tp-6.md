...
- La connexion : Tester si couple email/password correcte => generation token pour etre re utilisé dans le front
...
Compléter les 3 pages du premier TP (Login, Inscription, Récupération de mot passe) avec les appel API