...
1. Pourquoi MongoDB ne gère-t-il pas les clés étrangères comme SQL ?
2. Quels problèmes peuvent apparaître si un produit est supprimé alors que des avis existent ?
3. Dans quels cas l’imbrication des avis serait-elle préférable au référencement ?
